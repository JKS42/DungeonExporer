...
- **Perspective**: TBD — *first-person* or *third-person over-the-shoulder*.
...
3. NPC dialogue, item descriptions, and room flavor are generated by the local LLM, conditioned on the room and player state.
4. Solve / fight / loot.
...
|---|---|---|
| NPC dialogue | LLM generates NPC responses conditioned on NPC persona + world state. | Planned |
